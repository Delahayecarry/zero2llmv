...
flowchart TD
    ...
    subgraph TransformerProcessing["🧠 Transformer多模态处理"]
        ...
        subgraph LayerStack["📚 Transformer层堆栈"]
            ...
            L0["Layer 0: TransformerBlock<br/>⚡ MultiHead Attention + FFN/MoE<br/>📊 [B, L, H] → [B, L, H]"]
            L1["Layer 1: TransformerBlock<br/>⚡ Cross-modal Attention<br/>📊 视觉-文本信息交互"]
            L2["Layer 2: TransformerBlock<br/>⚡ Deep Semantic Fusion<br/>📊 高层语义理解"]
            LN["Layer N-1: TransformerBlock<br/>⚡ Final Representation<br/>📊 最终多模态表示"]
...
VLM 通过精心设计的多模态张量流处理管道，实现了高效的视觉-语言理解与生成：
